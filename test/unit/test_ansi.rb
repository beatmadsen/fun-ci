...
class TestAnsi < Minitest::Test
  def test_should_wrap_text_in_green
    result = FunCi::Tui::Ansi.green("hello")
  ...
  def test_should_wrap_text_in_bold_green
    result = FunCi::Tui::Ansi.bold_green("PASSED")
  ...
  def test_should_wrap_text_in_bold_red
    result = FunCi::Tui::Ansi.bold_red("FAILED")
  ...
  def test_should_wrap_text_in_bold_yellow
    result = FunCi::Tui::Ansi.bold_yellow("TIMED OUT")
  ...
  def test_should_wrap_text_in_dim
    result = FunCi::Tui::Ansi.dim("2m ago")
  ...
  def test_should_render_charcoal_background
    result = FunCi::Tui::Ansi.bg_charcoal("fun-ci")
  ...
  def test_should_strip_all_ansi_codes
    colored = FunCi::Tui::Ansi.bold_green("PASSED")
    result = FunCi::Tui::Ansi.strip(colored)
